...
public class GestorRegistroDeRespuestaController
{
    ...
    private void tomarOpcionOperador()
    {
        ...
        opcionValidaciones1.add(opcionValidacion3);
        opcionValidaciones1.add(opcionValidacion4);
        opcionValidaciones1.add(opcionValidacion5);
        ...
        opcionValidaciones1.add(opcionValidacion7);
        opcionValidaciones1.add(opcionValidacion8);
        opcionValidaciones1.add(opcionValidacion9);
        ...
        opcionValidaciones1.add(opcionValidacion10);
        opcionValidaciones1.add(opcionValidacion11);
        opcionValidaciones1.add(opcionValidacion12);
